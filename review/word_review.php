 ...
 */
 select {
  ...
  <link rel="stylesheet" type="text/css" href="word_review.css" />
...
<div style="height:540px; width:94%; float:left;  ">
	<div style=" margin-left: 75px; margin-top:95px;">      
   <div class="ch-grid">
      <li>
          ...
          <div class="ch-info">
            <h1>
             <!-- <form action="../MCQ/mcq_initiate.php">
                <input type="image" src="../images/fcre_mean_hover.png" alt="Submit" style="margin-top:5px; margin-left:20px;">
              </form>-->
             <a href="../wlists/beg_look.php"> 
              <img src="../images/beg_hover.png" style="margin-top:20px; margin-left:40px;">
              </a>
            </h1>
      ...
      <li>
        <div class="ch-item ch-img-2" style="margin-left:120px;">
          <div class="ch-info">
            <h2> 
              <a herf="../images/wl_hover.png">
             <img src="../images/int_hover.png" style="margin-top:20px; margin-left:40px;" >
           </a>
            </h2>
         </div>
        </div>
      ...
      <li>
        <div class="ch-item ch-img-3" style="margin-left:240px;">
          <div class="ch-info">
            <h2> 
              <a herf="../images/wl_hover.png">
             <img src="../images/exp_hover.png" style="margin-top:20px; margin-left:40px;" >
           </a>
            </h2>
         </div>
        </div>
  ...
  <div style="margin-left:100px; height:25px; margin-top:15px; text-align:center; font-size: 1.3em;word-wrap:break-word;  word-wrap:break-word; color: #fffefe; font-weight: 100; letter-spacing: 0.5px; ">
    <div style="width:250px; float:left; font-family:'Droid Sans';">
      NOVICE
    </div>
    <div style="width:250px; float:left; margin-left:130px; font-family:'Droid Sans';">
      INTERMEDIATE
    </div>
    <div style="width:250px; float:left; margin-left:120px; font-family:'Droid Sans';">
      MASTER
    </div>
  </div>

  <div style="height:5px; margin-left:80px;margin-top:5px; margin-bottom:10px;">
   ...
   <div style="height:5px; width:260px; float:left; margin-left:130px;">
        <hr style="width:25%; height:5px; margin-left:auto; margin-right:auto; display:block; border:0; border-top: 5px solid #fffefe;"></hr>
   </div>
   <div style="height:5px; width:260px; float:left; margin-left:765px;">
        <hr style="width:25%; height:5px; margin-left:auto; margin-right:auto; display:block; border:0; border-top: 5px solid #fffefe;"></hr>
   </div>
  </div>
  ...
  <div style="height:100px; margin-left:200px; margin-top:20px; text-align:center;font-size: 1.0em; word-wrap:break-word; color: #fffefe; font-weight: 100; letter-spacing: 1px; line-height: 150%;">
    <div style="width:240px; float:left; margin-left:-90px; ">
     Review your words! Click here to see all the word you have already learnt and revise!
   </div>
   <div style="width:240px; float:left;  margin-left:135px;">
      How many words have you mastered? Get to know your word levels here!
    </div>
     <div style="width:240px; float:left;  margin-left:140px;">
      How many words have you mastered? Get to know your word levels here!
    </div>
 </div>
</div>
