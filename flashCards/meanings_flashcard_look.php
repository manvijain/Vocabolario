...
include 'meanings_flashcard.php';
?>
<head>
   <style>
    /*div 
...
<body style="background:url(../images/4.png);">
  ...
  <nav class="menu slide-menu-left">
    ...
    <div style="height:475px; width:94%; float:left; font-family:'Puritan';  ">
        ...
        <form action="insert_words.php" method="POST" style="margin-top:475px;">
        <input type="submit" name="synonyms" value="Synonyms" style="margin-left:80px;">
