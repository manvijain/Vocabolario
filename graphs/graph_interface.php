   ...
   <div class="ch-grid">
          ...
          <div class="ch-info">
            <h1>
             ...
             <a href="flash_review.php"> 
              <img src="../images/daily_hover.png" style="margin-top:15px; margin-left:35px;">
              </a>
            </h1>
      ...
      <li>
        <div class="ch-item ch-img-2" style="margin-left:222px;">
          <div class="ch-info">
            <h1> 
              <a href="../graph day to day/graph_list.php">
             <img src="../images/word_hover.png" style="margin-top:15px; margin-left:35px;" >
           </a>
            </h1>
         </div>
        </div>
